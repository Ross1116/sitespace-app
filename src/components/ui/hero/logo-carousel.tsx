...
export default function LogoCarousel({ logos, className }: LogoCarouselProps) {
  ...
  return (
    <div className={cn("relative overflow-hidden", className)}>
      ...
      <div className="absolute left-0 top-0 z-10 h-full w-16 bg-gradient-to-r from-white dark:from-slate-950 to-transparent"></div>
      ...
      <div className="absolute right-0 top-0 z-10 h-full w-16 bg-gradient-to-l from-white dark:from-slate-950 to-transparent"></div>
    </div>
  )
}
