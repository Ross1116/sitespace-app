    ...
    <div ref={rootRef} className={styles.root}>
      ...
      <AuroraBackground>
        <div className="absolute inset-0 z-0">
          <BackgroundRippleEffect
            ...
            style={
              {
                "--cell-border-color": "rgba(148, 176, 222, 0.14)",
                "--cell-fill-color": "rgba(216, 232, 255, 0.05)",
                "--cell-ripple-color": "rgba(170, 204, 255, 0.2)",
                "--cell-shadow-color": "rgba(170, 204, 255, 0.2)",
      ...
      >
        <div className="max-w-7xl mx-auto px-6 text-center">
          <div className={cn(styles.fadeIn, "mb-8 md:mb-10")} data-fade-in>
      ...
      {/* Lookahead Dashboard */}
      <section className="px-6 pb-24 pt-0 md:px-6 md:pb-30">
        <div className="max-w-6xl mx-auto px-6">
          <div
            className={cn(
          ...
          >
            <div className="flex items-center justify-between mb-8">
              ...
              <div
                ...
                style={{
                  background: "color-mix(in oklab, var(--teal) 14%, white 86%)",
                  borderColor: "color-mix(in oklab, var(--teal) 25%, white 75%)",
                }}
              >
            ...
            <div className="grid gap-6 mb-8">
              ...
              <ForecastCard
                ...
                fillStyle={{
                  width: "45%",
                  background:
                    "linear-gradient(90deg, color-mix(in oklab, var(--teal) 78%, white 22%) 0%, var(--brand-blue) 100%)",
                }}
                fillWidth="45%"
                subtitle="Week of Feb 17-21"
              />
              ...
              <ForecastCard
                ...
                badgeLabel="Low"
                badgeStyle={{
                  background: "color-mix(in oklab, var(--brand-blue) 12%, white 88%)",
                  borderColor: "color-mix(in oklab, var(--brand-blue) 24%, white 76%)",
                  color: "var(--brand-blue)",
                }}
                fillStyle={{
                  width: "25%",
                  background:
                    "linear-gradient(90deg, color-mix(in oklab, var(--brand-blue) 72%, white 28%) 0%, var(--teal) 100%)",
                }}
                fillWidth="25%"
                subtitle="Week of Feb 17-21"
              />
            ...
            <div
              style={{
                background: "color-mix(in oklab, var(--teal) 10%, white 90%)",
                padding: 20,
                borderRadius: 12,
                border: "1px solid color-mix(in oklab, var(--teal) 22%, white 78%)",
              }}
            >
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          >
            <HighlightCard
              ...
              iconWrapStyle={{
                background:
                  "color-mix(in oklab, var(--brand-blue) 14%, white 86%)",
              }}
              icon={
                <svg
                  className="w-6 h-6"
            ...
            <HighlightCard
              ...
              iconWrapStyle={{
                background:
                  "color-mix(in oklab, var(--brand-orange) 14%, white 86%)",
              }}
              icon={
                <svg
                  className="w-6 h-6"
      ...
      {/* Coming Soon */}
      <section
        className={cn(styles.sectionSpacing, "pt-8 md:pt-12")}
        style={{
      ...
      <section
        ...
        style={{
          background:
            "linear-gradient(180deg, #ffffff 0%, #eef5f7 50%, #ffffff 100%)",
        }}
      >
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="mx-auto grid w-full max-w-5xl gap-16 px-2 md:grid-cols-2 md:px-6">
            <div className={styles.fadeIn} data-fade-in>
          ...
          <div className="grid md:grid-cols-5 gap-12 mb-12">
            <div className="md:col-span-2">
              ...
              <p className="text-gray-500 text-sm leading-relaxed">
                ...
                <br />
                complexities of the modern job site.
              </p>
            </div>
