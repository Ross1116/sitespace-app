        ...
        <table className="min-w-full w-full h-full bg-amber-50">
          <thead>
            <tr className="bg-orange-200 text-gray-700 uppercase text-sm">
              <th className="sticky top-0 py-3 px-6 text-left">Title</th>
              <th className="sticky top-0 py-3 px-6 text-left">Type</th>
              <th className="sticky top-0 py-3 px-6 text-left">Time</th>
              <th className="sticky top-0 py-3 px-6 text-left">Duration</th>
              <th className="sticky top-0 py-3 px-6 text-left">Status</th>
              <th className="sticky top-0 py-3 px-6 text-center">Actions</th>
            </tr>
          </thead>
