      ...
      <div className="flex min-h-screen w-full bg-white font-sans">
        <div className="hidden lg:flex w-1/2 bg-[var(--navy)] relative flex-col justify-between p-16 text-white">
           <div className="z-10">
             ...
             <p className="text-slate-400 text-xl">The invitation token is invalid.</p>
           </div>
        </div>
        <div className="w-full lg:w-1/2 flex items-center justify-center p-8">
          <div className="w-full max-w-md text-center">
            ...
            <p className="text-slate-500 mb-8">This invitation link is invalid or has expired. Please ask the project manager to resend the invite.</p>
            <Button onClick={() => router.push('/login')} className="w-full h-12 bg-[var(--navy)] text-white font-bold rounded-xl">Go to Login</Button>
          </div>
        </div>
      </div>
    );
